...
from coord2region.image_utils import add_watermark, generate_mni152_image


@patch("coord2region.image_utils.plot_stat_map")
@patch("coord2region.image_utils.load_mni152_template")
